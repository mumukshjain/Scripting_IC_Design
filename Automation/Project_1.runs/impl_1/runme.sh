...
HD_PWD='/home/mumuksh24/IC_Design/scripting-and-automation/Automation/Project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ripplebit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_ripplebit.tcl -notrace
