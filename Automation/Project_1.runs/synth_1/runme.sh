...
HD_PWD='/home/mumuksh24/IC_Design/scripting-and-automation/Automation/Project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ripplebit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ripplebit.tcl
